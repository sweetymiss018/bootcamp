  ...
  return (
    <div   ref={parentDivRef}  className="h-[150vh] w-full flex  items-center justify-end sm:h-[150vh] xs-lg:h-[190vh] md:h-[150vh] lg:h-[150vh]">
      ...
      >
        ...
        <div className="form relative h-full w-[55%]  flex justify-center items-center sm:h-[50%] xs-lg:h-[60%] sm:w-full xs-lg:w-full md:h-full lg:h-full md:top-[30px] sm:top-[30px] xs-lg:top-[30px] lg:top-[170px]">
          <BootcampForm/>
        </div>
